...
{
    if ((executor.getGrade() <= this->getExecuteGrade()) && getSignature() == true)
        this->executeSpecificForm();
    else
        throw Form::FailureToExecuteException();
}
...
const char * Form::FailureToExecuteException::what () const throw ()
{
